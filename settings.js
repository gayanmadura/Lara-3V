...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "DdR0XLJL#d6-LDtvMx0dTA-T0CxSBgnHYuY7ibL0EAyhM8t_brMs", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "private",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94789402259",
DEV: process.env.DEV || "94789402259",
